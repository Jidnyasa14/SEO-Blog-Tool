...
//     title: "Top 10 Essential Regex Hacks for Modern Developers",
//     slug: "top-regex-hacks",
//     excerpt: "Master simple regex patterns for validation and text cleaning.",
//     category: "Developer",
//     image: "https://images.unsplash.com/photo-1542831371-29b0f74f9713",
//     readingTime: 4,
//     date: "June 12, 2026",
...
//     title: "Why Client-Side Web Tools Are Better For Your Privacy",
//     slug: "client-side-privacy",
//     excerpt: "Explore how browser-based tools keep your data secure.",
//     category: "Utility",
//     image: "https://images.unsplash.com/photo-1563986768609-322da13575f3",
//     readingTime: 6,
//     date: "June 08, 2026",
...
// // ================= COMPONENT =================
// export default function HomePage() {
//   // Always displaying initial premium popular tool options
//   const featuredTools = ALL_TOOLS.slice(0, 8);

//   return (
//     <main className="flex flex-col min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-zinc-100 antialiased selection:bg-violet-500/30 dark:selection:bg-[#A6FF5D]/30 transition-colors duration-200">
//       <Navbar />
...
//       {/* AD CONTAINER - Fully responsive glassmorphism layer */}
//       <div className="flex justify-center py-6 border-y border-slate-200 dark:border-white/5 bg-white/40 dark:bg-black/20 backdrop-blur-md">
//         <AdSlot slot="leaderboard" />
//       </div>
...
//                 key={cat.label}
//                 href={cat.path}
//                 className="group flex flex-col items-center text-center gap-2 p-6 bg-white dark:bg-[#0d0e12] border border-slate-200 dark:border-white/5 rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:border-violet-600/40 dark:hover:border-[#A6FF5D]/40 hover:shadow-xs dark:hover:shadow-[0_0_30px_rgba(166,255,93,0.05)]"
//               >
//                 <div className="w-12 h-12 bg-slate-100 dark:bg-white/5 rounded-xl flex items-center justify-center text-2xl mb-2 transition-transform duration-300 group-hover:scale-110">
//                   {cat.icon}
//                 </div>
